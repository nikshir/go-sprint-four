...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	meanSpeedSquareMsec := math.Pow(meanSpeed(action, duration)*kmhInMsec, 2)
	return ((walkingCaloriesWeightMultiplier*weight + (meanSpeedSquareMsec/heightInM)*walkingSpeedHeightMultiplier*weight) * duration * minInH)
}
...
// swimmingDistance возвращает дистанцию в километрах при плавании.
//
// Параметры:
//
// lengthPool int — длина бассейна в метрах.
// countPool int — сколько раз пользователь переплыл бассейн.
// func swimmingDistance(lenghtPool, countPool int) float64 {
